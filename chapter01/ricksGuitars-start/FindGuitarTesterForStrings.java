public class FindGuitarTesterForStrings {

  public static void main(String[] args) {
    // Set up Rick's guitar inventory
    InventoryHandlingGuitarWithStrings inventory = new InventoryHandlingGuitarWithStrings();
    initializeInventory(inventory);

    GuitarWithAllStrings whatErinLikes = new GuitarWithAllStrings("", 0, "fender", "Stratocastor",
                                      "electric", "Alder", "Alder");
    GuitarWithAllStrings guitar = inventory.search(whatErinLikes);
    if (guitar != null) {
  ...
  private static void initializeInventory(InventoryHandlingGuitarWithStrings inventory) {
